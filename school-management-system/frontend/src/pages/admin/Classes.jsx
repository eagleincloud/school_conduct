...
const Classes = () => {
  ...
  const saveSection = async (e) => {
    ...
    try {
      if (editingSection) {
        await api.patch(
          `classes/admin-sections/${editingSection.id}/`,
          payload,
        );
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ margin: "0 0 10px", fontSize: "17px" }}>
          Class Hierarchy
        </h2>
        {loading ? (
          ...
          <div style={{ display: "grid", gap: "10px" }}>
            ...
            {!hierarchy.length && (
              <p style={{ color: "#6b7280" }}>No classes yet.</p>
            )}
          </div>
        )}
      </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <select
                value={assignForm.class_section_id}
                onChange={(e) =>
                  setAssignForm({
                    ...assignForm,
            ...
            >
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setSectionForm({ ...sectionForm, class_id: e.target.value })
                  }
                  style={inputStyle}
                  required
                >
              ...
              <div>
                ...
                <select
                  value={sectionForm.assigned_shift}
                  onChange={(e) =>
                    setSectionForm({
                      ...sectionForm,
